...
describe IO::Text do
  describe "#check" do
    it "checks current character" do
      parser = IO::Text.new IO::Memory.new("Lorem ipsum"), 4
    ...
    it "checks current characters" do
      parser = IO::Text.new IO::Memory.new("Lorem ipsum"), 6
    ...
    it "returns false at end of file" do
      parser = IO::Text.new IO::Memory.new, 4
  ...
  describe "#each_byte" do
    it "yields each byte" do
      str = "pi = -3.1419"
      bytes = [] of UInt8
      IO::Text.new(IO::Memory.new(str), 4).each_byte { |byte| bytes << byte }
      bytes.should eq str.bytes
    end

    it "updates buffer if break" do
      parser = IO::Text.new(IO::Memory.new("abcdef 123"), 4)
  ...
  describe "#count_bytes_while" do
    it "counts bytes for which block returns true" do
      parser = IO::Text.new IO::Memory.new("123 hello world"), 6
    ...
    it "counts bytes starting at offset" do
      parser = IO::Text.new IO::Memory.new("123 hello world"), 10
  ...
  describe "#eof?" do
    it "tells if it is at the end of file" do
      parser = IO::Text.new IO::Memory.new("123 hello")
  ...
  describe "#eol?" do
    it "tells if it is at the end of line" do
      parser = IO::Text.new IO::Memory.new("123 \nhello\r\n\t world"), 10
  ...
  describe "#peek" do
    ...
    it "returns up to N characters without advancing IO position" do
      parser = IO::Text.new IO::Memory.new("hello world"), 4
    ...
    it "returns nil at end of file" do
      parser = IO::Text.new IO::Memory.new
  ...
  describe "#read" do
    it "reads N characters" do
      parser = IO::Text.new IO::Memory.new("123 hello"), 4
  ...
  describe "#read_bytes_until" do
    ...
    it "reads the rest of the IO if delimiter is not found" do
      str = "hello world!"
      parser = IO::Text.new IO::Memory.new(str), 4
  ...
  describe "#read_float?" do
    it "reads a float" do
      parser = IO::Text.new IO::Memory.new("hello -123.45 abc"), 10
      parser.skip_until ' '
    ...
    it "reads a float ending at buffer size" do
      parser = IO::Text.new IO::Memory.new("abc -123.4 def"), 10
    ...
    it "reads a float cut at buffer size" do
      parser = IO::Text.new IO::Memory.new("abcd  1.2E3 fgh"), 10
      parser.read_bytes_until ' '
    ...
    it "returns nil for trailing non-whitespace characters" do
      str = "123.456abc"
      parser = IO::Text.new IO::Memory.new(str), 8
      parser.read_float?.should be_nil
  ...
  describe "#read_int?" do
    it "reads an integer" do
      parser = IO::Text.new IO::Memory.new("hello 1234 abc"), 10
      parser.skip_until ' '
    ...
    it "reads an integer at the end" do
      parser = IO::Text.new IO::Memory.new("abc 1234"), 6
      parser.read_bytes_until ' '
      parser.read_int?.should eq 1234
    ...
    it "reads an integer ending at buffer size" do
      parser = IO::Text.new IO::Memory.new("abc -123 def"), 8
      parser.read_bytes_until ' '
    ...
    it "reads an integer cut at buffer size" do
      parser = IO::Text.new IO::Memory.new("abcd  123456 fgh"), 10
      parser.read_bytes_until ' '
  ...
  describe "#read_line" do
    it "reads a line" do
      parser = IO::Text.new IO::Memory.new("Lorem ipsum\ndolor sit amet\r\nabc")
    ...
    it "fails at eof" do
      expect_raises IO::EOFError do
        IO::Text.new(IO::Memory.new).read_line
      end
    end
  end
  ...
  describe "#read_word?" do
    it "reads consecutive non-whitespace characters" do
      str = "The quick\n brown\t\tfox jumps \t\nover the lazy dog"
      parser = IO::Text.new IO::Memory.new(str)
      ary = [] of String
    ...
    it "returns nil at eof" do
      IO::Text.new(IO::Memory.new).read_word?.should be_nil
    end
  end

  describe "#scan" do
    it "reads characters until block returns false" do
      parser = IO::Text.new IO::Memory.new("123 abcdef \r\n56.7"), 8
    ...
    it "reads characters in charset" do
      parser = IO::Text.new IO::Memory.new("abc:_:def\n"), 6
  ...
  describe "#skip_while" do
    ...
    it "reads and discards all bytes if block always returns true" do
      parser = IO::Text.new IO::Memory.new("hello"), 2
      parser.skip_while(&.chr.letter?)
      parser.read_to_end.should eq ""
    end

    it "does not skip if block returns false" do
      parser = IO::Text.new IO::Memory.new("hello")
      parser.skip_while(&.chr.whitespace?)
      parser.read_to_end.should eq "hello"
    end
  end
