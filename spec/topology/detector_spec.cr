...
describe Chem::Topology::Detector do
  it_detects "protein residues", "5e61--unwrapped.poscar", {
    ...
    "GLY" => [
      {10 => "CA", 11 => "C", 75 => "H", 76 => "HA2", 77 => "HA1", 168 => "N",
       182 => "O"},
      {42 => "CA", 43 => "C", 125 => "H", 126 => "HA2", 127 => "HA1", 175 => "N",
       192 => "O"},
    ],
    "SER" => [
  ...
  it_detects "protein residues in a dipeptide", "AlaIle--unwrapped.poscar", {
    "ALA" => [
      {2 => "CA", 3 => "C", 29 => "O", 13 => "HA", 1 => "CB", 15 => "HB2",
       14 => "HB3", 16 => "HB1", 31 => "N", 10 => "H1", 11 => "H2"},
    ],
    "ILE" => [
      {4 => "CA", 32 => "N", 12 => "H", 17 => "HA", 6 => "CB", 7 => "CG1", 8 => "CD1",
       23 => "HD12", 24 => "HD13", 27 => "HD11", 21 => "HG12", 22 => "HG11", 9 => "CG2",
       19 => "HG22", 26 => "HG21", 20 => "HG23", 18 => "HB", 5 => "C", 28 => "O",
       30 => "OXT", 25 => "HXT"},
    ],
  }
