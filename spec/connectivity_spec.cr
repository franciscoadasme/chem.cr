...
describe Chem::Angle do
  describe ".[]" do
    it "creates an angle" do
      a, b, c = fake_structure.atoms
      Chem::Angle[a, b, c].should eq Chem::Angle.new(a, b, c)
    end
  end
  ...
  describe "#atoms" do
    it "returns the atoms" do
      a, b, c = fake_structure.atoms
      Chem::Angle[a, b, c].atoms.should eq({a, b, c})
    end
  end
  ...
  describe "#inspect" do
    it "inspect into the angle" do
      ...
      Chem::Angle[a, b, c].inspect.should eq expected
    end
  end
  ...
  describe "#measure" do
    it "measures the angle" do
      a, b, c = fake_structure.atoms
      Chem::Angle[a, b, c].measure.should be_close 110.071, 1e-3
    end
  end
  ...
  describe "#to_s" do
    it "returns a string representation" do
      ...
      Chem::Angle[a, b, c].to_s.should eq expected
    end
  end
end
...
describe Chem::Dihedral do
  describe ".[]" do
    it "creates a dihedral angle" do
      a, b, c, d = fake_structure.atoms
      Chem::Dihedral[a, b, c, d].should eq Chem::Dihedral.new(a, b, c, d)
    end
  end
  ...
  describe "#<=>" do
    it "compares two dihedral angles" do
      ...
      a1 = Chem::Dihedral[a, b, c, d]
      a2 = Chem::Dihedral[b, c, d, e]
      (a1 <=> a2).should eq -1
      (a1 <=> a1).should eq 0
      (a2 <=> a1).should eq 1
    end
  ...
  describe "#==" do
    it "compares two dihedral angles" do
      a, b, c, d, e = fake_structure.atoms
      a1 = Chem::Dihedral[a, b, c, d]
      a2 = Chem::Dihedral[d, c, b, a]
      a3 = Chem::Dihedral[b, c, d, e]
      a1.should eq a1
      a1.should eq a2
      a1.should_not eq a3
    end
  ...
  describe "#atoms" do
    it "returns the atoms" do
      a, b, c, d = fake_structure.atoms
      Chem::Dihedral[a, b, c, d].atoms.should eq({a, b, c, d})
    end
  end
  ...
  describe "#inspect" do
    it "inspect into the dihedral angle" do
      ...
      Chem::Dihedral[a, b, c, d].inspect.should eq expected
    end
  end
  ...
  describe "#measure" do
    it "measures the dihedral angle" do
      a, b, c, d = fake_structure.atoms
      Chem::Dihedral[a, b, c, d].measure.should be_close -50.435, 1e-3
    end
  end
  ...
  describe "#to_s" do
    it "returns a string representation" do
      ...
      Chem::Dihedral[a, b, c, d].to_s.should eq expected
    end
  end
end
...
describe Chem::Improper do
  describe ".[]" do
    it "creates a improper dihedral angle" do
      a, b, c, d = fake_structure.atoms
      Chem::Improper[a, b, c, d].should eq Chem::Improper.new(a, b, c, d)
    end
  end
  ...
  describe "#<=>" do
    it "compares two improper dihedral angles" do
      a, b, c, d, e = fake_structure.atoms
      a1 = Chem::Improper[a, b, c, d]
      a2 = Chem::Improper[b, c, d, e]
      (a1 <=> a2).should eq -1
      (a1 <=> a1).should eq 0
      (a2 <=> a1).should eq 1
    end
  ...
  describe "#==" do
    it "compares two improper dihedral angles" do
      a, b, c, d, e = fake_structure.atoms
      a1 = Chem::Improper[a, b, c, d]
      a2 = Chem::Improper[c, b, a, d]
      a3 = Chem::Improper[b, c, d, e]
      a1.should eq a1
      a1.should eq a2
      a1.should_not eq a3
    end
  ...
  describe "#atoms" do
    it "returns the atoms" do
      a, b, c, d = fake_structure.atoms
      Chem::Improper[a, b, c, d].atoms.should eq({a, b, c, d})
    end
  end
  ...
  describe "#inspect" do
    it "inspect into the improper dihedral angle" do
      ...
      expected = "Chem::Improper{<Atom A:ASP1:N(1)>, <Atom A:ASP1:CA(2)>, \
                  <Atom A:ASP1:C(3)>, <Atom A:ASP1:O(4)>}"
      Chem::Improper[a, b, c, d].inspect.should eq expected
    end
  end
  ...
  describe "#measure" do
    it "measures the improper dihedral angle" do
      a, b, c, d = fake_structure.atoms
      Chem::Improper[a, b, c, d].measure.should be_close 137.514, 1e-3
    end
  end
  ...
  describe "#to_s" do
    it "returns a string representation" do
      ...
      Chem::Improper[a, b, c, d].to_s.should eq expected
    end
  end
end
