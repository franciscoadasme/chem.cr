...
describe Chem::Topology do
  ...
  describe "#angles" do
    it "returns the angles" do
      ...
      top.angles.map(&.map(&.serial)).sort!.should eq [
  ...
  describe "#dihedrals" do
    it "returns the dihedrals" do
      top = load_file("8FX.mol2").topology
      top.dihedrals.map(&.map(&.serial)).sort!.should eq [
        {1, 2, 3, 4}, {1, 2, 3, 31}, {1, 28, 27, 15}, {1, 28, 27, 26},
        {1, 28, 29, 4}, {1, 28, 29, 24}, {2, 1, 28, 27}, {2, 1, 28, 29},
        {2, 3, 4, 29}, {2, 3, 4, 32}, {3, 2, 1, 28}, {3, 2, 1, 30},
        {3, 4, 29, 24}, {3, 4, 29, 28}, {4, 3, 2, 23}, {4, 29, 24, 25},
        {4, 29, 28, 27}, {5, 6, 7, 8}, {5, 6, 7, 16}, {5, 15, 27, 26},
        {5, 15, 27, 28}, {5, 17, 16, 7}, {5, 17, 16, 46}, {6, 5, 15, 27},
        {6, 5, 15, 45}, {6, 5, 17, 16}, {6, 7, 8, 21}, {6, 7, 8, 22},
        {6, 7, 8, 34}, {6, 7, 16, 17}, {6, 7, 16, 46}, {7, 6, 5, 15},
        {7, 6, 5, 17}, {7, 8, 21, 22}, {7, 8, 21, 48}, {7, 8, 21, 49},
        {7, 8, 22, 21}, {7, 8, 22, 50}, {7, 8, 22, 51}, {8, 7, 6, 33},
        {8, 7, 16, 17}, {8, 7, 16, 46}, {8, 21, 22, 50}, {8, 21, 22, 51},
        {8, 22, 21, 48}, {8, 22, 21, 49}, {9, 18, 10, 11}, {9, 18, 10, 35},
        {9, 18, 10, 36}, {9, 18, 13, 12}, {9, 18, 13, 40}, {9, 18, 13, 41},
        {9, 25, 24, 29}, {9, 25, 26, 27}, {10, 11, 14, 42}, {10, 11, 14, 43},
        {10, 11, 14, 44}, {10, 11, 19, 12}, {10, 11, 19, 47}, {10, 18, 9, 20},
        {10, 18, 9, 25}, {10, 18, 13, 12}, {10, 18, 13, 40}, {10, 18, 13, 41},
        {11, 10, 18, 13}, {11, 19, 12, 13}, {11, 19, 12, 38}, {11, 19, 12, 39},
        {12, 19, 11, 14}, {12, 19, 11, 37}, {13, 12, 19, 47}, {13, 18, 9, 20},
        {13, 18, 9, 25}, {13, 18, 10, 35}, {13, 18, 10, 36}, {14, 11, 10, 18},
        {14, 11, 10, 35}, {14, 11, 10, 36}, {14, 11, 19, 47}, {15, 5, 6, 33},
        {15, 5, 17, 16}, {15, 27, 26, 25}, {15, 27, 28, 29}, {16, 7, 6, 33},
        ...
        {24, 29, 4, 32}, {24, 29, 28, 27}, {25, 24, 29, 28}, {25, 26, 27, 28},
        {26, 25, 24, 29}, {26, 27, 15, 45}, {26, 27, 28, 29}, {27, 28, 1, 30},
  ...
  describe "#impropers" do
    it "returns the impropers" do
      top = load_file("8FX.mol2").topology
      top.impropers.map(&.map(&.serial)).sort!.should eq [
        {1, 2, 3, 23}, {1, 2, 23, 3}, {1, 28, 27, 29}, {1, 28, 29, 27},
        {2, 1, 28, 30}, {2, 1, 30, 28}, {2, 3, 4, 31}, {2, 3, 31, 4},
        {3, 2, 23, 1}, {3, 4, 29, 32}, {3, 4, 32, 29}, {4, 3, 31, 2},
        {4, 29, 24, 28}, {4, 29, 28, 24}, {5, 6, 7, 33}, {5, 6, 33, 7},
        {5, 15, 27, 45}, {5, 15, 45, 27}, {6, 5, 15, 17}, {6, 5, 17, 15},
        {6, 7, 8, 16}, {6, 7, 16, 8}, {7, 6, 33, 5}, {7, 8, 21, 22},
        {7, 8, 21, 34}, {7, 8, 22, 21}, {7, 8, 22, 34}, {7, 8, 34, 21},
        {7, 8, 34, 22}, {7, 16, 17, 46}, {7, 16, 46, 17}, {8, 7, 16, 6},
        {8, 21, 22, 48}, {8, 21, 22, 49}, {8, 21, 48, 22}, {8, 21, 48, 49},
        {8, 21, 49, 22}, {8, 21, 49, 48}, {8, 22, 21, 50}, {8, 22, 21, 51},
        {8, 22, 50, 21}, {8, 22, 50, 51}, {8, 22, 51, 21}, {8, 22, 51, 50},
        {9, 18, 10, 13}, {9, 18, 13, 10}, {9, 25, 24, 26}, {9, 25, 26, 24},
        {10, 11, 14, 19}, {10, 11, 14, 37}, {10, 11, 19, 14}, {10, 11, 19, 37},
        {10, 11, 37, 14}, {10, 11, 37, 19}, {10, 18, 13, 9}, {11, 10, 18, 35},
        {11, 10, 18, 36}, {11, 10, 35, 18}, {11, 10, 35, 36}, {11, 10, 36, 18},
        {11, 10, 36, 35}, {11, 14, 42, 43}, {11, 14, 42, 44}, {11, 14, 43, 42},
        {11, 14, 43, 44}, {11, 14, 44, 42}, {11, 14, 44, 43}, {11, 19, 12, 47},
        {11, 19, 47, 12}, {12, 13, 18, 40}, {12, 13, 18, 41}, {12, 13, 40, 18},
        {12, 13, 40, 41}, {12, 13, 41, 18}, {12, 13, 41, 40}, {12, 19, 47, 11},
        {13, 12, 19, 38}, {13, 12, 19, 39}, {13, 12, 38, 19}, {13, 12, 38, 39},
        {13, 12, 39, 19}, {13, 12, 39, 38}, {14, 11, 19, 10}, {14, 11, 19, 37},
        {14, 11, 37, 10}, {14, 11, 37, 19}, {15, 5, 17, 6}, {15, 27, 26, 28},
        {15, 27, 28, 26}, {17, 16, 46, 7}, {18, 9, 20, 25}, {18, 9, 25, 20},
        {18, 10, 35, 11}, {18, 10, 35, 36}, {18, 10, 36, 11}, {18, 10, 36, 35},
        {18, 13, 40, 12}, {18, 13, 40, 41}, {18, 13, 41, 12}, {18, 13, 41, 40},
        {19, 11, 37, 10}, {19, 11, 37, 14}, {19, 12, 38, 13}, {19, 12, 38, 39},
        {19, 12, 39, 13}, {19, 12, 39, 38}, {20, 9, 25, 18}, {21, 8, 22, 7},
        {21, 8, 22, 34}, {21, 8, 34, 7}, {21, 8, 34, 22}, {21, 22, 50, 8},
        {21, 22, 50, 51}, {21, 22, 51, 8}, {21, 22, 51, 50}, {22, 8, 34, 7},
        {22, 8, 34, 21}, {22, 21, 48, 8}, {22, 21, 48, 49}, {22, 21, 49, 8},
        {22, 21, 49, 48}, {24, 25, 26, 9}, {24, 29, 28, 4}, {26, 27, 28, 15},
        {27, 15, 45, 5}, {27, 28, 29, 1}, {28, 1, 30, 2}, {29, 4, 32, 3},
        {35, 10, 36, 11}, {35, 10, 36, 18}, {38, 12, 39, 13}, {38, 12, 39, 19},
        {40, 13, 41, 12}, {40, 13, 41, 18}, {42, 14, 43, 11}, {42, 14, 43, 44},
        {42, 14, 44, 11}, {42, 14, 44, 43}, {43, 14, 44, 11}, {43, 14, 44, 42},
        {48, 21, 49, 8}, {48, 21, 49, 22}, {50, 22, 51, 8}, {50, 22, 51, 21},
      ]
    end
  end
end
