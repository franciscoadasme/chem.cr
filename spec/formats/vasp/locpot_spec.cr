...
describe Chem::VASP::Locpot do
  describe ".read" do
    it "reads a LOCPOT" do
      path = spec_file("vasp/LOCPOT")
      grid = Chem::VASP::Locpot.read path
  ...
  describe ".write" do
    it "writes a LOCPOT" do
      ...
      io = IO::Memory.new
      Chem::VASP::Locpot.write io, grid, structure
