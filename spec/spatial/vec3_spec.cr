...
describe Chem::Spatial::Vec3 do
  ...
  describe ".zero" do
    it "returns a vector zero" do
      vec3(0, 0, 0).should eq vec3(0, 0, 0)
    end
  end
  ...
  describe "#+" do
    ...
    it "sums a vector and a size" do
      (vec3(1, 2, 3) + Chem::Spatial::Size3[3, 2, 1]).should eq vec3(4, 4, 4)
    end
  end
  ...
  describe "#-" do
    ...
    it "subtracts a size from a vector" do
      (vec3(1, 2, 3) - Chem::Spatial::Size3[3, 2, 1]).should eq vec3(-2, 0, 2)
    end
  end
  ...
  describe "#to_fract" do
    it "converts Cartesian to fractional coordinates" do
      ...
      vec3(0, 0, 0).to_fract(cell).should eq vec3(0, 0, 0)
