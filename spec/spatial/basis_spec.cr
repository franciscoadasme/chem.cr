...
describe Chem::Spatial::Basis do
  describe ".new" do
    ...
    it "creates a basis with size" do
      basis = Basis.new Size[74.23, 135.35, 148.46]
    ...
    it "creates a basis with size and angles" do
      basis = Basis.new Size[8.661, 11.594, 21.552], 86.389999, 82.209999, 76.349998
  ...
  describe "#==" do
    it "tells if two basis are equal" do
      b1 = Basis.new Size[8.661, 11.594, 21.552], 86.389999, 82.209999, 76.349998
      b1.should eq b1
      b1.transform # triggers internal caching
      b1.should eq Basis.new(Size[8.661, 11.594, 21.552], 86.389999, 82.209999, 76.349998)
      b1.should_not eq Basis.new(Size[8.661, 11.594, 21.552])
    end
  end

  describe "#a" do
    it "return the size of the first vector" do
      Basis.new(Size[8.661, 11.594, 21.552]).a.should eq 8.661
      Basis.new(Size[8.661, 11.594, 21.552], 86.39, 82.201, 76.345).a.should eq 8.661
    end
  end
  ...
  describe "#b" do
    it "return the size of the second vector" do
      Basis.new(Size[8.661, 11.594, 21.552]).b.should eq 11.594
      Basis.new(Size[8.661, 11.594, 21.552], 86.39, 82.201, 76.345).b.should eq 11.594
    end
  end
  ...
  describe "#c" do
    it "return the size of the third vector" do
      Basis.new(Size[8.661, 11.594, 21.552]).c.should eq 21.552
      Basis.new(Size[8.661, 11.594, 21.552], 86.39, 82.201, 76.345).c.should be_close 21.552, 1e-8
    end
  end
  ...
  describe "#size" do
    it "returns basis' size" do
      Basis.new(Size[5, 5, 4], 90, 90, 120).size.should be_close Size[5, 5, 4], 1e-15
      basis = Basis.new Vec3[1, 0, 0], Vec3[2, 2, 0], Vec3[0, 1, 1]
      basis.size.should be_close Size[1, Math.sqrt(8), Math.sqrt(2)], 1e-15
    end
  end
end
