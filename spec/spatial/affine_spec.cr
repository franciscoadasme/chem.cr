...
describe Chem::Spatial::AffineTransform do
  ...
  describe ".rotation" do
    it "returns a rotation transformation" do
      transform = Chem::Spatial::AffineTransform.rotation(Chem::Spatial::Vec3[1, 0, 0], 90)
      transform.linear_map.should be_close Chem::Spatial::Mat3[
        {1, 0, 0},
        {0, 0, -1},
        {0, 1, 0},
      ...
      transform = Chem::Spatial::AffineTransform.rotation(Chem::Spatial::Vec3[0.67, 0.68, 0.3], 180)
      transform.linear_map.should be_close Chem::Spatial::Mat3[
      ...
      transform = Chem::Spatial::AffineTransform.rotation(Chem::Spatial::Vec3[0.67, 0.68, 0.3], 360)
      transform.linear_map.should be_close Chem::Spatial::Mat3.identity, 1e-15
      transform.offset.should eq [0, 0, 0]

      transform = Chem::Spatial::AffineTransform.rotation(Chem::Spatial::Vec3[0.31, 0.91, -0.28], 46)
      transform.linear_map.should be_close Chem::Spatial::Mat3[
  ...
  describe ".translation" do
    it "returns a translation transformation" do
      transform = Chem::Spatial::AffineTransform.translation(Chem::Spatial::Vec3[1, 2, 3])
      transform.linear_map.should eq Chem::Spatial::Mat3.identity
      transform.offset.should eq Chem::Spatial::Vec3[1, 2, 3]
    end
  end

  describe "#*" do
    it "transforms a vector" do
      (Chem::Spatial::AffineTransform.translation(Chem::Spatial::Vec3[1, -2, 3]) * Chem::Spatial::Vec3[0, 0, 0]).should eq Chem::Spatial::Vec3[1, -2, 3]
      (Chem::Spatial::AffineTransform.scaling(4.5, 1, 2.3) * Chem::Spatial::Vec3[1, 2, 3]).should be_close Chem::Spatial::Vec3[4.5, 2, 6.9], 1e-8
    end

    it "transforms a vector (inverse)" do
      transform = Chem::Spatial::AffineTransform.scaling(4.5, 1, 2.3)
      (Chem::Spatial::Vec3[1, 2, 3] * transform).should eq Chem::Spatial::Vec3[1 / 4.5, 2, 3 / 2.3]
    end

    it "combines two transformations" do
      a = Chem::Spatial::AffineTransform.translation(Chem::Spatial::Vec3[1, 2, 3])
      b = Chem::Spatial::AffineTransform.scaling(2)
      transform = b * a
      transform.linear_map.should eq Chem::Spatial::Mat3[{2, 0, 0}, {0, 2, 0}, {0, 0, 2}]
      transform.offset.should eq Chem::Spatial::Vec3[2, 4, 6]
    end
  ...
  describe "#rotate" do
    it "rotates the transformation" do
      ...
      angle = rand * 180
      transform = Chem::Spatial::AffineTransform.identity.translate(Chem::Spatial::Vec3[1, 2, 3]).scale(2.5)
  ...
  describe "#scale" do
    it "scales the transformation" do
      offset = Chem::Spatial::Vec3[0.2, 0.13, 0.35]
    ...
    it "scales the transformation wit different factors" do
      ...
      transform.offset.should eq offset * Chem::Spatial::Vec3[*factors]
    end
  end
  ...
  describe "#to_s" do
    it "returns a string representation" do
      expected = "[\
        ...
        [0  0  0  1]]"
      transform = Chem::Spatial::AffineTransform.translation(Chem::Spatial::Vec3[1, 2, 3]).scale(2).rotate(45, 15, 90)
  ...
  describe "#translate" do
    it "translates the transformation" do
      offset = Chem::Spatial::Vec3[1, 2, 3]
