...
describe Chem::Spatial::PBC do
  describe "#each_adjacent_image" do
    ...
    it "yields periodic images within cutoff for a off-center non-orthogonal cell" do
      ...
      expected = [
        cell.image(atoms[29].coords, {0, 0, 1}),
        cell.image(atoms[29].coords, {-1, 0, 0}),
        cell.image(atoms[29].coords, {-1, 0, 1}),
        cell.image(atoms[65].coords, {0, -1, -1}),
        cell.image(atoms[65].coords, {0, -1, 0}),
        cell.image(atoms[65].coords, {0, 0, -1}),
        cell.image(atoms[65].coords, {1, -1, -1}),
        cell.image(atoms[65].coords, {1, -1, 0}),
        cell.image(atoms[65].coords, {1, 0, 0}),
        cell.image(atoms[65].coords, {1, 0, -1}),
        cell.image(atoms[115].coords, {-1, 0, 0}),
        cell.image(atoms[115].coords, {-1, 0, 1}),
        cell.image(atoms[115].coords, {-1, 1, 0}),
        cell.image(atoms[115].coords, {-1, 1, 1}),
        cell.image(atoms[115].coords, {0, 0, 1}),
        cell.image(atoms[115].coords, {0, 1, 0}),
        cell.image(atoms[115].coords, {0, 1, 1}),
        cell.image(atoms[126].coords, {1, 0, 0}),
        cell.image(atoms[174].coords, {-1, 0, 0}),
        cell.image(atoms[174].coords, {-1, 1, 0}),
        cell.image(atoms[174].coords, {0, 1, 0}),
        cell.image(atoms[187].coords, {-1, 0, 0}),
        cell.image(atoms[187].coords, {-1, 0, 1}),
        cell.image(atoms[187].coords, {0, 0, 1}),
        cell.image(atoms[192].coords, {0, -1, 0}),
        cell.image(atoms[192].coords, {1, -1, 0}),
        cell.image(atoms[192].coords, {1, 0, 0}),
      ].sort_by!(&.to_a)
      vectors.size.should eq expected.size
    ...
    it "fails when radius is negative" do
      ...
      structure.cell = Chem::Spatial::Parallelepiped.cubic(10)
